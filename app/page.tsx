		...
		<div className="flex flex-col min-h-screen">
						...
						<div className="grid md:grid-cols-2 gap-12 items-center">
							<div>
								<p className="text-lg mb-4">
									...
									cognitive decline, and learning difficulties such as ADHD and
									dyslexia.
								</p>
								<p className="text-lg mb-4">
				...
				<section id="contact" className="bg-light-blue py-20">
					<div className="container">
						...
						<div className="grid md:grid-cols-2 gap-12 items-center">
							<div>
								<p className="text-lg mb-4">
									Have questions or want to schedule a consultation? Our team is
									here to help you navigate your journey towards cognitive
			...
			<footer className="bg-gray-900 text-white py-8">
				<div className="container">
					<div className="grid md:grid-cols-3 gap-8">
						<div>
							<h3 className="text-lg font-semibold mb-4">NeuroLift Learning</h3>
